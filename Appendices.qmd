...
As previously mentioned, Python wrappers are included for most **dsld**
functions. 
...
As an example, let's use the Python interface for
**dsldTakeALookAround** (the Python-equivalent function is called
**dsldPyTakeALookAround**)  to view tabular information on how data
features relate to Y and S. The Python function allows users to enter
arguments using Python data types and converts the resultant R dataframe
into a Pandas dataframe.

Different Python functions will require different libraries depending on
what the function does -- **Pandas** [These libraries can also (usually)
be installed with **pip**]{.column-margin} is required for
