...
long been used by statisticians, and there are many R packages that
implement them.
...
new cases by averaging the predictions for that case by the individual
...
prediction accuracy (**testAcc** values) on a *holdout set*. In this
case, the Mean Absolute Prediction Error was about $20700 for women and
28000 for men.
