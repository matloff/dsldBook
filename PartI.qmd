...
it come from?  To motivate this, suppose that within each gender Y, X
has a normal (Gaussian) distribution, the familiar "bell-shaped" curve,
with the same standard deviation of Y within each gender.  Then it turns out
that one can show mathematically that
