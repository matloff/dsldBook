...
## On Causal Inference (advanced material) {#sec-causal}
...
race, for instance.  *Causal analysis* (CA) can be viewed both as a way
to deal with observational studies, and in its graphical forms, as a
descriptive alternative to traditional statistical relational analysis.  

Though CA takes on many forms, our discussion here will focus 
on two topics:
